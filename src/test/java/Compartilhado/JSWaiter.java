...
public class JSWaiter {
    ...
    private final By loading = By.id("waitSign");
    ...
    public void waitGifLoading() {
		try {
//			JavascriptExecutor js = (JavascriptExecutor) driver;
			if (driver.findElement(loading).isEnabled()) {
				// System.out.println("TEM LOADING");
				if (("block".equals(driver.findElement(loading).getCssValue("display")))) {
					// System.out.println("Dentro do
					// ExpectedConditions.visibilityOfElementLocated");
					jsWait.until(ExpectedConditions.invisibilityOfElementLocated(loading));
...
//	}
    ...
    public Boolean WaitElementIsRead(By Element) {
    	try {
    		waitJQueryAngular();
    		Passo.wait.until(ExpectedConditions.elementToBeClickable(Element));
    		return true;
		} catch (Exception e) {
			return false;
		}
